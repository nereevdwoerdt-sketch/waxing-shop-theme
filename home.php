 ...
 * Blog Home Template
 *
 * Displays the main blog posts page
 * Used when a static front page is set and page_for_posts is configured
 *
 * @package Waxing_Shop
 * @since 5.8
 */
    ...
    <section class="blog-header">
        <div class="container">
            ...
            <div class="blog-categories">
                <a href="<?php echo get_permalink(get_option('page_for_posts')); ?>" class="category-tag active">
                    Alles
                </a>
                <?php
